...
public class OdontologoJpaController implements Serializable {
    ...
    public void create(Odontologo odontologo) {
        ...
        try {
            ...
            ArrayList<Turno> attachedListaTurnos = new ArrayList<Turno>();
    ...
    public void edit(Odontologo odontologo) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            ArrayList<Turno> listaTurnosOld = persistentOdontologo.getListaTurnos();
            ArrayList<Turno> listaTurnosNew = odontologo.getListaTurnos();
            ArrayList<Turno> attachedListaTurnosNew = new ArrayList<Turno>();
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            ArrayList<Turno> listaTurnos = odontologo.getListaTurnos();
